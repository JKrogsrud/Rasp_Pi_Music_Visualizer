...
def CreateBars(array, color):
    ...
    draw = ImageDraw.Draw(im, None)  # Allow image to be 'drawn' upon
    max_height = max(max(array), 1)  # Make the max_height either the max of the array or 1 to prevent division by 0
